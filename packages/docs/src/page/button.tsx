...
import { Button, Table } from "dawn-ui";
    ...
    return (
        <main className="main">
            ...
            <Panel>
                <PanelItem>
                    <Button>默认按钮</Button>
                    <Button icon={'cat-circle'} >默认按钮</Button>
                    <Button dropdown>默认按钮</Button>
                    <Button icon={'cat-circle'} dropdown>默认按钮</Button>
                </PanelItem>
                <PanelCode>
                    {`
     render() {
     ...
     `}
            ...
            <Panel>
                <PanelItem>
                    ...
                    <Button type="secondary" icon={'cat-circle'} >默认按钮</Button>
                    <Button type="secondary" dropdown>默认按钮</Button>
                    <Button type="secondary" icon={'cat-circle'} dropdown>默认按钮</Button>
                </PanelItem>
                <PanelCode>
                    {`
     render() {
     ...
     `}
            ...
            <Panel>
                <PanelItem>
                    ...
                    <Button type="text" icon={'cat-circle'} >默认按钮</Button>
                    <Button type="text" dropdown>默认按钮</Button>
                    <Button type="text" icon={'cat-circle'} dropdown>默认按钮</Button>
                </PanelItem>
                <PanelCode>
                    {`
     render() {
     ...
     `}
            ...
            <Panel>
                <PanelItem>
                    <Button type="icon" icon={'cat-circle'} ></Button>
                    <Button type="icon" icon={'cat-circle'} dropdown></Button>
                </PanelItem>
                <PanelCode>
                    {`
     render() {
...
//                         <Button type={'danger'} icon={'cat-pause'}>测试</Button>
//                     </PanelItem>
//                     <PanelCode>
//                         {`
//     render() {
